  ...
  const projectsElement = projects.map((project) => {
    ...
    return (
      <div
        ...
        key={nanoid()}
      >
        <div className="w-full h-full flex items-center text-slate-950 p-4 justify-center text-center bg-light-yellow opacity-0 hover:opacity-90 transition-all duration-500 delay-700 rounded-2xl">
